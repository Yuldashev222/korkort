...
class QuestionSerializer(serializers.Serializer):
    ...
    question_video = serializers.URLField(default='https://e-report.uz/media/questions/18000%3A%200fac9957-9516-4083-9ae4/videos/giphy.gif')
    # question_image = serializers.ImageField(source='image')
    question_image = serializers.URLField(default='https://e-report.uz/media/chapters/1:%20836c4b38-fe8e-4ef2-9a9c-bab/lessons/1:%20905c9192-956f-4054-9ce1-161/images/Re_A8H4vJl.png')
