...
class CategoryExamAPIView(GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        questions_queryset = Question.objects.filter(**filter_data).order_by('?')[:data['questions']]
...
class ExamStudentResult(GenericAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        category_exams = ExamStudentCategorySerializer(category_exam_query, many=True).data
        data = {
