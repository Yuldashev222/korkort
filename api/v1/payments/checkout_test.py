    ...
    def create(self, request, *args, **kwargs):
        ...
        try:
            checkout_session = stripe.checkout.Session.create(
                ...
                mode='payment',
                success_url=f'http://{get_current_site(request)}/api/v1/payments/success/?order_id={order.id}',
                cancel_url=f'http://{get_current_site(request)}/api/v1/payments/cancel/?order_id={order.id}',
            )
